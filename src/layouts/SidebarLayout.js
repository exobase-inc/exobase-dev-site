      ...
      <Link href={isPublished ? href : fallbackHref}>
        <a
          className={clsx('block border-l pl-4 -ml-px', {
            'text-red-500 border-current font-semibold ': isActive,
...
function TopLevelNav({ mobile }) {
  ...
  return (
    <>
        ...
        icon={
          <>
            <path
              ...
              className={clsx(
                'fill-red-200 group-hover:fill-red-500',
            ...
            <path
              ...
              className={clsx(
                'fill-red-400 group-hover:fill-red-500',
                pathname.startsWith('/docs')
                  ? ' '
                  : ' '
              )}
      ...
      <TopLevelLink
        mobile={mobile}
        href="https://github.com/rayepps/radash/discussions"
        className="mb-8"
