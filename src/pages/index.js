      ...
      <div className="mb-20 bg-slate-50">
        ...
        <div className="min-h-screen p-16 relative flex items-center justify-center">
          <div className="absolute top-0 left-0 pt-16 px-16 w-full flex items-start">
            <div>
              ...
              <p className="text-slate-900 text-4xl tracking-tight font-extrabold sm:text-5xl max-w-[20vw]">
                Making multi cloud infrastructure possible
              </p>
            ...
            <div className="grow flex items-center justify-end">
              {/* <span className="block text-slate-900 hover:text-slate-800">Docs</span>
              <span className="ml-6 block text-slate-900 hover:text-slate-800">Blog</span>
              <span className="ml-6 block text-slate-900 hover:text-slate-800">Community</span> */}
              <a
                href="https://github.com/exobase-inc"
          ...
          <div className="absolute bottom-16 left-0 pt-16 px-16 w-full flex items-start">
            <div>
              <span className="text-slate-900 text-xl italic font-medium">A project in progress...</span>
            </div>
          </div>
